                    ...
                    <div class="post__content">
                        ...
                        <div class="post__content-info">
                            ...
                            <h2 class="post__title entry-title text-center">
                                <a href="{{route('post.single', ['slug'=>$post_one->slug])}}">{{$post_one->title}}</a>
                            </h2>
                            ...
                            <div class="post-additional-info">
                                        ...
                                        <span class="post__date">
                                            ...
                                            <time class="published" datetime="2016-04-17 12:00:00">
                                                {{$post_one->created_at->diffForHumans()}}
                                            </time>
                                ...
                                <span class="category">
                                            ...
                                            <a href="{{route('category.single', ['id'=>$post_one->category->id])}}">{{$post_one->category->name}}</a>
                                        </span>
                    ...
                    <div class="post__content">
                        ...
                        <div class="post__content-info">
                            ...
                            <h2 class="post__title entry-title ">
                                <a href="{{route('post.single', ['slug'=>$post_two->slug])}}">{{$post_two->title}}</a>
                            </h2>
                            ...
                            <div class="post-additional-info">
                                ...
                                <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="#">{{$post_two->category->name}}</a>
                                        </span>
                ...
                <article class="hentry post post-standard has-post-thumbnail sticky">
                    ...
                    <div class="post__content">
                        ...
                        <div class="post__content-info">
                            ...
                            <h2 class="post__title entry-title ">
                                <a href="{{route('post.single', ['slug'=>$post_threee->slug])}}">{{$post_threee->title}}</a>
                            </h2>
                            ...
                            <div class="post-additional-info">
                                        ...
                                        <span class="post__date">
                                            ...
                                            <time class="published" datetime="2016-04-17 12:00:00">
                                               {{$post_threee->created_at->toFormattedDateString()}}
                                            </time>
                                ...
                                <span class="category">
                                            <i class="seoicon-tags"></i>
                                            <a href="#">{{$post_threee->category->name}}</a>
                                        </span>
...
<script>
    @if(Session::has('subscribed'))
            toastr.subscribed('{{Session::get('subscribed')}}')
    @endif
